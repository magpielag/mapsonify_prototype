...
const mappingArray = selectChange()
var mappingVal = '0'
var mouseEventHandler = function () { }

function getMapping (mapOpt) {
  console.log(`Mapping has changed to ${mapOpt}`)
  if (mapOpt != null) {
    var changeArr = selectChange(mapOpt)
  } else { changeArr = selectChange() }
  mappingVal = changeArr[0]
  mouseEventHandler = changeArr[1]
  console.log(mappingVal, mouseEventHandler)
}

$('#synthCanvas').ready(getMapping('1'))
