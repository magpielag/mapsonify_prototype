...
$('#replayButton').click(function() {
  $('#replayButton').attr('disabled', true) // Set the button to be disabled/off until playback is finished.
  replayPath(userCoords).then(function() { $('#replayButton').attr('disabled', false) })
})
